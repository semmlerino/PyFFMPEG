...
### Task 4.1: Stderr Drain Thread 🔴 CRITICAL (CORRECTED)
...
**Success Metrics**:
- [ ] Bash sessions don't deadlock with verbose stderr
- [ ] Thread properly cleaned up on session close
- [ ] No thread object leaks after 100 session restarts
- [ ] Thread reference cleared even if join times out
