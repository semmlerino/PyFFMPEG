...
class ApplicationConfig:
    ...
    SETTINGS_FILE: Path = field(default_factory=lambda: Path.home() / ".shotbot" / "settings.json")
...
class ThumbnailConfig:
    ...
    FALLBACK_EXTENSIONS: list[str] = field(default_factory=lambda: [".exr", ".dpx", ".tiff"])
...
class VFXApplicationConfig:
    ...
    REZ_PACKAGES: dict[str, list[str]] = field(default_factory=lambda: {
        "nuke": ["nuke"],
        "maya": ["maya"],
        "3de": ["3de"],
    })
