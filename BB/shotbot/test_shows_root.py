...
def test_shows_root_configuration():
    ...
    print(f"Mock pool output contains correct path: {'/tmp/mock_vfx' in command_output}")
    ...
    print(f"Workspace path uses configured root: {'/tmp/mock_vfx' in shot.workspace_path}")
