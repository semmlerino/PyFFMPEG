...
from PySide6.QtWidgets import (
    ...
    QTabWidget, QGroupBox, QLabel, QPushButton, QCheckBox,
    QStatusBar, QToolBar, QDockWidget, QMenu, QMenuBar,
...
from ui_components import (
    ModernButton, NotificationBanner, ProgressOverlay,
    EmptyStateWidget, FloatingActionButton
)
...
class ImprovedMainWindow(QMainWindow):
    ...
    def _setup_right_panel(self):
        ...
        for display_name, app_id, shortcut, icon in app_configs:
            ...
            button.setAccessibleDescription(f"Opens {display_name} in the selected shot context")
