...
def test_failed_attempt_cache():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(f"1. Testing first failure attempt...")
        ...
        if cache_key in failed_status:
            ...
            print(f"   Failure recorded: attempts={failure_info['attempts']}, "
        ...
        print(f"   Should be None (skipped due to recent failure)")
        ...
        for attempt in range(1, 5):
            ...
            print(f"   Attempt #{failure_info['attempts']}: "
