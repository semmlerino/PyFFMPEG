...
def create_show_structure(base_dir: Path) -> tuple:
    ...
    user_shots = [
        MockShot(show_name, "AB_100", "AB_100_0010", str(shows_dir / "AB_100" / "AB_100_0010")),
        MockShot(show_name, "CD_200", "CD_200_0020", str(shows_dir / "CD_200" / "CD_200_0020")),
    ]
    ...
    for sequence, shots in structure.items():
        for shot in shots:
            ...
            if shot in ["AB_100_0010", "AB_100_0030", "CD_200_0010", "EF_300_0020", "EF_300_0040"]:
...
def test_show_wide_search():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        other_shot_scenes = [s for s in all_scenes if s.full_name not in user_shot_names]
        ...
        print(f"- Found {len(other_shot_scenes)} scenes from OTHER shots (not assigned to user)")
