...
class BaseThumbnailDelegate(QStyledItemDelegate):
    ...
    def _draw_placeholder(self, painter: QPainter, rect: QRect) -> None:
        ...
        painter.drawText(
            rect, Qt.AlignmentFlag.AlignCenter, "No Thumbnail"
        )
    ...
    def _draw_text(
        ...
        # Set text color
        if is_selected:
            painter.setPen(QPen(self.theme.text_selected_color))
        else:
            painter.setPen(QPen(self.theme.text_color))
        
        # Draw name
        painter.setFont(self._name_font)
        name_rect = QRect(text_rect.x(), text_rect.y(), text_rect.width(), 20)
        ...
        painter.setFont(self._info_font)
        info_rect = QRect(text_rect.x(), text_rect.y() + 20, text_rect.width(), 20)
