    ...
    try:
        ...
        if module_name == "imageio":
            try:
                ...
                if formats is not None and hasattr(formats, "search_read_format"):
                    exr_format = formats.search_read_format(".exr")
                    if exr_format:
                        result["exr_methods"].append(
                            f"formats.search_read_format(.exr) -> {exr_format.name}"
                        )
            except Exception:
                pass
    ...
    for lib in image_libs:
        ...
        if result["importable"]:
            ...
            if result["exr_methods"]:
                ...
                print("       No obvious EXR methods found")
...
def test_imageio_exr_support(result: Dict[str, Any]) -> None:
    ...
    try:
        ...
        print("      🔍 Testing imageio EXR capabilities...")
        ...
        try:
            ...
            if hasattr(imageio, "formats"):
                ...
                print(
                    f"         Available format search methods: {[m for m in dir(formats) if 'format' in m.lower()]}"
                )
...
def test_opencv_exr_support(result: Dict[str, Any]) -> None:
    ...
    try:
        ...
        print("      🔍 Testing OpenCV EXR capabilities...")
        ...
        if exr_constants:
            ...
            print("         No obvious EXR constants found")
...
def test_pil_exr_support(result: Dict[str, Any]) -> None:
    ...
    try:
        ...
        print("      🔍 Testing PIL/Pillow EXR capabilities...")
        ...
        if exr_formats:
            ...
            print("         No EXR formats registered in PIL")
...
def main():
    ...
    find_exr_related_modules(all_modules)
    ...
    print(
        f"✅ Working Python modules: {working_modules if working_modules else 'None'}"
    )
