...
class QRunnableTracker:
    ...
    def __init__(self) -> None:
        ...
        self._runnable_metadata: weakref.WeakKeyDictionary[QRunnable, dict[str, Any]] = (
    ...
    def register(self, runnable: QRunnable, metadata: Optional[dict[str, Any]] = None) -> None:
        """
...
def register_runnable(runnable: QRunnable, metadata: Optional[dict[str, Any]] = None) -> None:
