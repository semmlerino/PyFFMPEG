...
class RefactoredMainWindow(QMainWindow):
    ...
    def _setup_ui_via_manager(self) -> None:
        ...
        previous_shots_item_model = PreviousShotsItemModel(
            previous_shots_model, self.cache_manager
        )
    ...
    def _connect_component_signals(self) -> None:
        ...
        self.threading_manager.threede_discovery_started.connect(
            self._on_discovery_started
        )
        self.threading_manager.threede_discovery_finished.connect(
