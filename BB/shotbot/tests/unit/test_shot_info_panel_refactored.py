...
class TestShotInfoPanel:
    ...
    def test_set_shot_none_clears_display(self, qtbot, real_cache_manager, make_test_shot):
    ...
    def test_load_thumbnail_from_cache(self, qtbot, real_cache_manager, tmp_path, make_test_shot):
    ...
    def test_load_thumbnail_from_source(self, qtbot, real_cache_manager, tmp_path, monkeypatch):
    ...
    def test_load_thumbnail_no_cache_no_source(self, qtbot, real_cache_manager, tmp_path):
    ...
    def test_load_pixmap_from_path_nonexistent(self, qtbot, real_cache_manager, tmp_path, caplog):
    ...
    def test_load_pixmap_from_path_invalid_image(self, qtbot, real_cache_manager, tmp_path, caplog):
    ...
    def test_on_thumbnail_cached_current_shot(self, qtbot, real_cache_manager, tmp_path, make_test_shot):
    ...
    def test_on_thumbnail_cached_different_shot(self, qtbot, real_cache_manager, tmp_path, make_test_shot):
    ...
    def test_on_thumbnail_cached_no_current_shot(self, qtbot, real_cache_manager, tmp_path):
    ...
    def test_thumbnail_caching_starts_worker(self, qtbot, real_cache_manager, tmp_path, monkeypatch):
    ...
    def test_error_handling_permission_error(self, qtbot, real_cache_manager, tmp_path, caplog):
