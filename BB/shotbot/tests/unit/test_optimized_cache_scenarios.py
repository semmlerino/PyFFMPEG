...
class TestCacheScenarios:
    ...
    def test_cache_hit_scenario(self, optimized_model_with_cache):
        ...
        # Pre-populate cache
        cached_data = [
            {"show": "CACHED", "sequence": "seq01", "shot": "0010", "workspace_path": "/cached/path1"},
            {"show": "CACHED", "sequence": "seq01", "shot": "0020", "workspace_path": "/cached/path2"}
        ]
    ...
    def test_mixed_cache_scenarios(self, optimized_model_with_cache):
        ...
        model.cache_manager.cache_shots([
            {"show": "TEST", "sequence": "seq", "shot": "0010", "workspace_path": "/test"}
        ])
    ...
    def test_performance_metrics_accuracy(self, optimized_model_with_cache):
        ...
        # Add cache data
        model.cache_manager.cache_shots([{"show": "TEST", "sequence": "s", "shot": "1", "workspace_path": "/p"}])
    ...
    def test_concurrent_cache_access(self, optimized_model_with_cache):
        ...
        # Pre-populate cache
        model.cache_manager.cache_shots([
            {"show": "CONCURRENT", "sequence": "seq", "shot": "0010", "workspace_path": "/path"}
        ])
