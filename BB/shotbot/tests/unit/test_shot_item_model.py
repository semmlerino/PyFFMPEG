...
class TestShotItemModel:
    ...
    def test_data_custom_roles(self, shot_item_model, sample_shots):
        ...
        # WorkspacePathRole
        assert shot_item_model.data(index, ShotRole.WorkspacePathRole) == "/shows/test_show/seq01/seq01_shot01"
    ...
    def test_clear_thumbnail_cache(self, qtbot, shot_item_model, sample_shots, sample_thumbnail_pixmap):
        ...
        if roles:  # Roles might not be captured in all Qt versions
            assert ShotRole.ThumbnailPixmapRole in roles or Qt.ItemDataRole.DecorationRole in roles
    ...
    def test_get_thumbnail_pixmap(self, shot_item_model, sample_shots, sample_thumbnail_pixmap):
    ...
    def test_data_decoration_role(self, shot_item_model, sample_shots, sample_thumbnail_pixmap):
        ...
        shot_item_model._thumbnail_cache["seq01_shot01"] = sample_thumbnail_pixmap
        icon = shot_item_model.data(index, Qt.ItemDataRole.DecorationRole)
        assert isinstance(icon, QIcon) or icon is not None  # QIcon conversion might vary
