...
class TestEdgeCases:
    ...
    def test_leading_zeros_preserved(self) -> None:
        ...
        # Leading zeros should be parsed as integers
        assert obj._extract_version("file_v001.ma") == 1
    ...
    def test_version_at_start_of_filename(self) -> None:
        ...
        # Default pattern looks for _v###
        assert obj._extract_version("v001_file.ma") is None
        assert obj._extract_version("_v001_file.ma") == 1
