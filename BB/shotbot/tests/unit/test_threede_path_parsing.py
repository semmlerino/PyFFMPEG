...
class TestThreeDEPathParsing(unittest.TestCase):
    ...
    def test_publish_directory_construction(self):
        ...
        test_cases = [
            ...
            (
                ...
                "GF_256",
                "1400",
                "/shows/jack_ryan/shots/GF_256/GF_256_1400/publish",
            ),
            (
                "project",
                "ABC_123",
                "4567",
                "/shows/project/shots/ABC_123/ABC_123_4567/publish",
            ),
            ...
            (
                ...
                "LONG_SEQ_01",
                "0020",
                "/shows/test/shots/LONG_SEQ_01/LONG_SEQ_01_0020/publish",
            ),
        ]
        ...
        for show, sequence, shot, expected_path in test_cases:
            with self.subTest(show=show, sequence=sequence, shot=shot):
                ...
                constructed_path = (
                    f"/shows/{show}/shots/{sequence}/{sequence}_{shot}/publish"
                )
    ...
    def test_extract_plate_name_from_path(self):
        ...
        test_cases = [
            ...
            (
                "/shows/project/shots/SEQ_01/SEQ_01_0010/user/artist/3de/BG01_comp.3de",
                "BG01",
            ),
            (
                "/shows/project/shots/SEQ_01/SEQ_01_0010/user/artist/3de/fg01_track.3de",
                "fg01",
            ),
            (
                "/shows/project/shots/SEQ_01/SEQ_01_0010/user/artist/3de/SEQ_01_0010_comp.3de",
                "SEQ_01_0010",
            ),
            # Published paths
            (
                "/shows/project/shots/SEQ_01/SEQ_01_0010/publish/3de/BG01_final.3de",
                "BG01",
            ),
            (
                "/shows/project/shots/SEQ_01/SEQ_01_0010/publish/editorial/FG01_v002.3de",
                "FG01",
            ),
            # No clear plate name
            (
                "/shows/project/shots/SEQ_01/SEQ_01_0010/user/artist/3de/random_file.3de",
                "random",
            ),
        ]
        ...
        for path_str, expected_plate in test_cases:
            with self.subTest(path=path_str):
                ...
                self.assertTrue(
                    expected_plate.upper() in plate.upper()
                    or plate.upper() in expected_plate.upper(),
                )
