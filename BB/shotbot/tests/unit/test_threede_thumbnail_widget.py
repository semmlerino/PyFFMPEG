...
def sample_scene():
    ...
    return ThreeDEScene(
        ...
        user="testuser",
        plate="FG01",
        scene_path=Path("/shows/test_show/seq01/seq01_shot01/user/testuser/work/3de/scenes/test.3de")
    )
...
class TestThreeDEThumbnailWidget:
    ...
    def test_scene_with_different_plates(self, qtbot):
        ...
        scenes = [
            ...
            ThreeDEScene(
                ...
                workspace_path="/test", user="user2", plate="BG01",
                scene_path=Path("/test/bg.3de")
            ),
            ThreeDEScene(
                show="test", sequence="seq01", shot="shot03",
                workspace_path="/test", user="user3", plate="EL01",
    ...
    def test_widget_with_long_names(self, qtbot):
        ...
        assert "very_long_sequence_name_very_long_shot_name_0001" in widget.shot_label.text()
