...
class TestAsyncCallbackRaceConditions:
    ...
    def test_immutable_shot_identifier_capture(self, model, test_shots, qtbot, tmp_path):
        ...
        with patch.object(model._cache_manager, 'cache_thumbnail') as mock_cache:
            with patch.object(model, '_handle_thumbnail_success_atomically', track_handler):
    ...
    def test_qmetaobject_invoke_method_thread_safety(self, model, test_shots, qtbot):
        ...
        with patch.object(model, '_handle_thumbnail_success_atomically', mock_handler):
            ...
            QMetaObject.invokeMethod(
                model, "_handle_thumbnail_success_atomically",
    ...
    def test_concurrent_thumbnail_loading(self, model, test_shots, qtbot, tmp_path):
        ...
        with patch.object(model._cache_manager, 'cache_thumbnail', mock_cache_thumbnail):
    ...
    def test_thumbnail_cache_consistency_during_model_reset(self, model, test_shots, qtbot):
