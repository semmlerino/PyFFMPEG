...
class TestShotDeduplication(unittest.TestCase):
    ...
    def test_deduplication_single_shot_multiple_files(self):
        ...
        scenes = [
            self.create_test_scene("jack_ryan", "GF_256", "1400", "artist1", "GF_256_1400_v001.3de", base_time),
            self.create_test_scene("jack_ryan", "GF_256", "1400", "artist2", "GF_256_1400_v002.3de", base_time + 100),
            self.create_test_scene("jack_ryan", "GF_256", "1400", "artist3", "GF_256_1400_v003.3de", base_time + 200),
        ]
    ...
    def test_deduplication_multiple_shots(self):
        ...
        scenes = [
            ...
            self.create_test_scene("jack_ryan", "GF_256", "1410", "artist1", "GF_256_1410_v001.3de", base_time + 50),
            self.create_test_scene("jack_ryan", "GF_256", "1410", "artist3", "GF_256_1410_v002.3de", base_time + 150),
            
            # Shot 1420 - single version
            self.create_test_scene("jack_ryan", "GF_256", "1420", "artist2", "GF_256_1420_v001.3de", base_time + 200),
        ]
    ...
    def test_deduplication_published_vs_user(self):
        ...
        scenes = [
            # User workspace file
            self.create_test_scene("jack_ryan", "GF_256", "1400", "artist1", "GF_256_1400_wip.3de", base_time, is_published=False),
            # Published file (older but might have priority)
            self.create_test_scene("jack_ryan", "GF_256", "1400", "published-3de", "GF_256_1400_final.3de", base_time - 100, is_published=True),
            # Another user file (newest)
            self.create_test_scene("jack_ryan", "GF_256", "1400", "artist2", "GF_256_1400_latest.3de", base_time + 100, is_published=False),
        ]
    ...
    def test_deduplication_different_shows(self):
        ...
        scenes = [
            ...
            self.create_test_scene("jack_ryan", "SEQ_01", "0010", "artist1", "SEQ_01_0010.3de", base_time),
            self.create_test_scene("other_show", "SEQ_01", "0010", "artist2", "SEQ_01_0010.3de", base_time + 100),
            self.create_test_scene("third_show", "SEQ_01", "0010", "artist3", "SEQ_01_0010.3de", base_time + 200),
        ]
    ...
    def test_deduplication_with_plate_names(self):
        ...
        scenes = [
            ...
            self.create_test_scene("jack_ryan", "GF_256", "1400", "artist1", "BG01_comp.3de", base_time),
            self.create_test_scene("jack_ryan", "GF_256", "1400", "artist2", "FG01_track.3de", base_time + 100),
            self.create_test_scene("jack_ryan", "GF_256", "1400", "artist3", "BG01_final.3de", base_time + 200),
        ]
    ...
    def test_single_scene(self):
        ...
        scene = self.create_test_scene("jack_ryan", "GF_256", "1400", "artist1", "test.3de", datetime.now().timestamp())
    ...
    def test_my_shots_vs_other_scenes_separation(self):
        ...
        scenes = [
            ...
            self.create_test_scene("jack_ryan", "GF_256", "1400", current_user, "GF_256_1400_mine.3de", base_time),
            # User's assigned shot - someone else's file
            self.create_test_scene("jack_ryan", "GF_256", "1400", "other_artist", "GF_256_1400_other.3de", base_time + 100),
            
            # Another user's assigned shot
            self.create_test_scene("jack_ryan", "GF_256", "1410", "different_artist", "GF_256_1410.3de", base_time),
            
            # Shot not assigned to anyone (should go to "Other 3DE scenes")
            self.create_test_scene("jack_ryan", "GF_256", "1420", "random_artist", "GF_256_1420.3de", base_time),
        ]
