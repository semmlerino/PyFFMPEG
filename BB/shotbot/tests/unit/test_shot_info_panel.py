...
class TestShotInfoPanel:
    ...
    def test_set_shot_updates_display(self, shot_info_panel, sample_shot):
        ...
        assert shot_info_panel.shot_name_label.text() == "seq01_shot01"  # full_name is sequence_shot
        assert shot_info_panel.show_sequence_label.text() == "test_show • seq01"
        assert shot_info_panel.path_label.text() == "Workspace: /shows/test_show/seq01/shot01"
    ...
    def test_load_thumbnail_from_cache(self, shot_info_panel, sample_shot, 
                                       mock_cache_manager, thumbnail_image):
    ...
    def test_load_thumbnail_from_source(self, shot_info_panel, sample_shot,
                                        mock_cache_manager, thumbnail_image, qtbot):
        ...
        with patch.object(sample_shot, 'get_thumbnail_path', return_value=thumbnail_image):
            shot_info_panel.set_shot(sample_shot)
    ...
    def test_load_thumbnail_no_cache_no_source(self, shot_info_panel, sample_shot,
                                               mock_cache_manager):
    ...
    def test_load_pixmap_from_path_invalid_image(self, shot_info_panel, tmp_path, caplog):
    ...
    def test_on_thumbnail_cached_current_shot(self, shot_info_panel, sample_shot,
                                             thumbnail_image):
    ...
    def test_on_thumbnail_cached_no_current_shot(self, shot_info_panel, thumbnail_image):
        ...
        assert shot_info_panel.thumbnail_label.text() == "" or \
               shot_info_panel.thumbnail_label.text() == "No Image"
    ...
    def test_thumbnail_caching_starts_worker(self, mock_thread_pool, shot_info_panel,
                                            sample_shot, mock_cache_manager, thumbnail_image):
    ...
    def test_error_handling_permission_error(self, shot_info_panel, tmp_path, caplog, monkeypatch):
    ...
    def test_error_handling_memory_error(self, shot_info_panel, tmp_path, caplog, monkeypatch):
    ...
    def test_error_handling_io_error(self, shot_info_panel, tmp_path, caplog, monkeypatch):
    ...
    def test_error_handling_unexpected_error(self, shot_info_panel, tmp_path, caplog, monkeypatch):
