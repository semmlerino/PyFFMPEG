...
class DeadlockDetector:
    ...
    def detect_deadlock(
        ...
        if cycles:
            ...
            involved_threads = [
                t for t in threads 
                if t.name in involved_thread_names
            ]
...
class PerformanceMetrics:
    ...
    def measure_lock_contention(
        ...
        return PerformanceMetrics._calculate_statistics(
            "lock_contention", durations, total_operations,
    ...
    def measure_signal_latency(
        ...
        return PerformanceMetrics._calculate_statistics(
            "signal_latency", durations, len(durations),
    ...
    def compare_before_after(
        ...
        improvement_percent = (
            ...
            / before_result.avg_duration_ms * 100
        )
...
def monitored_worker(qtbot) -> Iterator[LauncherWorker]:
    ...
    worker.worker_error.connect(lambda msg: state_changes.append((time.perf_counter(), f"ERROR: {msg}")))
