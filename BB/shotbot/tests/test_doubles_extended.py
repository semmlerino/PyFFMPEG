...
class TestQtWidget:
    ...
    def disconnect(self, signal_name: str, callback: Optional[callable] = None) -> None:
...
class TestProcessPoolDouble:
    ...
    def __init__(self):
        ...
        self.fail_with_message: Optional[str] = None
    ...
    def invalidate_cache(self, command: Optional[str] = None) -> None:
    ...
    def get_execution_count(self, command_pattern: Optional[str] = None) -> int:
    ...
    def get_last_kwargs(self, command: Optional[str] = None) -> Dict[str, Any]:
