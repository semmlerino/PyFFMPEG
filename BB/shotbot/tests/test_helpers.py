...
class TestCacheData:
    ...
    @staticmethod
    def create_test_image_file(filepath: Path, width: int = 100, height: int = 100) -> Path:
...
def create_test_shot(show: str = "test", seq: str = "seq001", shot: str = "shot0010") -> Dict[str, str]:
...
def create_test_process_result(success: bool = True, output: str = "Test output") -> Tuple[bool, str]:
