        ...
        for show_dir in shows_dir.iterdir():
            ...
            for seq_dir in shots_dir.iterdir():
                ...
                for shot_dir in seq_dir.iterdir():
                    ...
                    workspace_path = f"{Config.SHOWS_ROOT}/{show_name}/shots/{seq_name}/{shot_name}"
...
def create_mock_pool_from_filesystem() -> MockWorkspacePool:
    ...
    logger.error("This ensures 'Other 3DE Scenes' can find 3DE files from non-assigned shots")
