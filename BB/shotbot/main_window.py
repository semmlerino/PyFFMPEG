...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self) -> None:
        ...
        for app_name, command in Config.APPS.items():
            ...
            button.clicked.connect(lambda checked=False, app=app_name: self._launch_app(app))
    ...
    def _setup_accessibility(self) -> None:
        ...
        AccessibilityManager.setup_shot_grid_accessibility(self.threede_shot_grid, "3de")
        AccessibilityManager.setup_shot_grid_accessibility(self.previous_shots_grid, "previous")
