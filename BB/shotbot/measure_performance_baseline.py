...
def measure_startup_time() -> Dict[str, float]:
    ...
    with patch("subprocess.run") as mock_run:
        mock_run.return_value = MagicMock(
            stdout="test_show seq01 shot001 /shows/test",
            returncode=0
        )
...
def main():
    ...
    results["summary"] = {
        ...
        "cache_write_speed": 100 / results["cache_metrics"]["cache_100_shots"],  # shots/sec
        "cache_read_speed": 100 / results["cache_metrics"]["read_100_shots"],  # shots/sec
    }
    ...
    print(f"  Cache Write Speed: {results['summary']['cache_write_speed']:.0f} shots/sec")
