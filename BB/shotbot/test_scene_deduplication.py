...
def test_deduplication():
    ...
    scenes = [
        ThreeDEScene(
            ...
            user="published-mm",
            plate="FG01",
            scene_path=Path("/shows/jack_ryan/shots/GF_256/GF_256_1420/publish/mm/default/fg01/lens_distortion/v001/3de/GF_256_1420_mm-default_fg01_v001.3de"),
        ),
        ThreeDEScene(
            show="jack_ryan",
            sequence="GF_256",
            ...
            user="published-mm",
            plate="FG01",
            scene_path=Path("/shows/jack_ryan/shots/GF_256/GF_256_1420/publish/mm/default/fg01/lens_distortion/v002/3de/GF_256_1420_mm-default_fg01_v002.3de"),
        ),
        ThreeDEScene(
            show="jack_ryan",
            sequence="GF_256",
            ...
            user="published-mm",
            plate="BG01",
            scene_path=Path("/shows/jack_ryan/shots/GF_256/GF_256_1420/publish/mm/default/bg01/lens_distortion/v001/3de/GF_256_1420_mm-default_bg01_v001.3de"),
        ),
        ThreeDEScene(
            show="jack_ryan",
            sequence="GF_256",
            ...
            user="rob-o",
            plate="FG01",
            scene_path=Path("/shows/jack_ryan/shots/GF_256/GF_256_0980/user/rob-o/3de/scenes/test.3de"),
        ),
    ]
