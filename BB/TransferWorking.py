        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    self.error.emit(f"Archive extraction failed: {e!s} / {e2!s}")
                    return
...
class FolderTransferApp(QMainWindow):
    ...
    def add_chunk(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Error", f"Failed to process chunk: {e!s}")
        ...
        try:
            ...
            if file_size > 5 * 1024 * 1024:  # 5MB
                ...
                try:
                    ...
                    QMessageBox.critical(
                        self, "File Error", f"Failed to read file: {e!s}"
                    )
                    return
