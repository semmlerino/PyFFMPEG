...
class TestFeatureFlagSwitching:
    ...
    def test_standard_model_when_flag_not_set(
    ...
    def test_legacy_model_when_flag_set(
        self, qapp: "QApplication", qtbot: "QtBot"
    ) -> None:
...
class TestMainWindowIntegration:
    ...
    def test_window_initialization_with_default_model(
        self, qapp: "QApplication", qtbot: "QtBot"
    ) -> None:
    ...
    def test_window_initialization_with_legacy_model(
        self, qapp: "QApplication", qtbot: "QtBot"
    ) -> None:
    ...
    def test_closeEvent_handles_optimized_model(
        self, qapp: "QApplication", qtbot: "QtBot"
    ) -> None:
