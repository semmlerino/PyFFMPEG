...
class TestMainWindowCompleteWorkflows:
    ...
    def test_threede_scene_workflow(
    ...
    def test_tab_switching_workflow(
        self, qtbot: QtBot, main_window: MainWindow
    ) -> None:
    ...
    def test_settings_dialog_workflow(
        self, qtbot: QtBot, main_window: MainWindow
    ) -> None:
    ...
    def test_resize_and_layout_workflow(
        self, qtbot: QtBot, main_window: MainWindow
    ) -> None:
    ...
    def test_status_bar_updates_workflow(
        self, qtbot: QtBot, main_window: MainWindow
    ) -> None:
