...
class TestInitialization:
    ...
    def test_initialization_sets_valid_variables(
...
class TestCommandSyntaxValidation:
    ...
    def test_valid_command_without_variables(
        self, validator: LauncherValidator
    ) -> None:
...
class TestVariableSubstitution:
    ...
    def test_substitution_with_custom_vars(self, validator: LauncherValidator) -> None:
    ...
    def test_shotbot_version_substitution(self, validator: LauncherValidator) -> None:
...
class TestEdgeCases:
    ...
    def test_case_sensitivity_in_validation(self, validator: LauncherValidator) -> None:
