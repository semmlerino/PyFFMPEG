...
class TestProcessMonitor:
    ...
    def test_create_process_widget(self):
        ...
        with self.qtbot.waitSignal(self.monitor.widget_created, timeout=100):
            self.monitor.create_process_widget(QProcess(), "/test/video2.ts")
    ...
    def test_remove_process_widget(self):
        ...
        with patch.object(
            self.monitor.scroll_area, "widget", return_value=mock_scroll_widget
        ):
    ...
    def test_clear_all_widgets(self):
        ...
        assert len(processes) == 3  # Verify we created 3 processes
    ...
    def test_emit_progress_updated_signal(self):
        ...
        self.mock_process_manager.get_overall_progress.return_value = {
            "test_process": {"current_pct": 40}
        }
        self.mock_process_manager.get_process_progress.return_value = {
            "current_pct": 40
        }
